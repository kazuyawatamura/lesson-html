- [タグの入れ子（ネスト）と要素ごとのルール](#タグの入れ子ネストと要素ごとのルール)
      - [参考](#参考)
  - [要素の分類（コンテンツモデル）](#要素の分類コンテンツモデル)
  - [要素ごとのタグの入れ子ルール](#要素ごとのタグの入れ子ルール)
    - [divタグ：構造・レイアウト](#divタグ構造レイアウト)
    - [spanタグ：構造・レイアウト](#spanタグ構造レイアウト)
    - [h1〜h6タグ：見出し、pタグ：段落](#h1h6タグ見出しpタグ段落)
    - [ul / olタグ：リスト定義](#ul--olタグリスト定義)
    - [liタグ：リスト定義（子要素）](#liタグリスト定義子要素)
      - [html5の入れ子タグのチートシート](#html5の入れ子タグのチートシート)
  - [開始タグと閉じタグの位置を合わせましょう](#開始タグと閉じタグの位置を合わせましょう)
