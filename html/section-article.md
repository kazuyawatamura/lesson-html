- [見出しタグの使い方とセクショニング](#見出しタグの使い方とセクショニング)
  - [見出しタグは目次の各章](#見出しタグは目次の各章)
    - [1ページに対して ```<h1>``` 1つ](#1ページに対して-h1-1つ)
    - [トップページと下層ページ](#トップページと下層ページ)
  - [セクショニングについて](#セクショニングについて)
    - [header](#header)
    - [nav](#nav)
    - [main](#main)
    - [article](#article)
    ...
    - [aside](#aside)
    - [footer](#footer)
  - [マークアップ例でみる使い分け方](#マークアップ例でみる使い分け方)
  - [HTMLタグ付けの例](#htmlタグ付けの例)
    - [サイトのヘッダー周りの実例](#サイトのヘッダー周りの実例)
      - [解説](#解説)
    - [メインコンテンツ周りの例](#メインコンテンツ周りの例)
      - [解説](#解説-1)
    - [フッター周りの例](#フッター周りの例)
      - [解説](#解説-2)
  - [HTMLは国語のようなものです](#htmlは国語のようなものです)
